...
def lightsaber(input_dataframe, model, verify_inf):
    colon_names = ['dx_tm', 'dx_tra', 'dx_tsk', 'dx_tku', 'dx_fshm', 'dx_fshstd2', 'dx_fshsk', 'dx_fshku', 'dx_fv',
                  ...
                  'tacc_fshsk', 'tacc_fshku', 'tacc_fv', 'tacc_fsk', 'tacc_fkur', 'cur_tm', 'cur_tra', 'cur_tsk',
                  'cur_tku', 'cur_fshm', 'cur_fshstd2', 'cur_fshsk', 'cur_fshku', 'cur_fv', 'cur_fsk', 'cur_fkur',
                  'curroc_tm', 'curroc_tra', 'curroc_tsk', 'curroc_tku', 'curroc_fshm', 'curroc_fshstd2',
                  'curroc_fshsk', 'curroc_fshku', 'curroc_fv', 'curroc_fsk', 'curroc_fkur']
    # r2_d2 = []
    ...
    # simply judge by the hbc
    if colon_military.loc[0, "hbc"] == 2:
...
def main():
    ...
    # data = pd.read_csv("/Users/kite/Desktop/Mobile_verify/Data/trainData/PC/human_2018042710953.csv")
    # data = pd.DataFrame()
    # print(data.loc[0, ["correct_x", "correct_y", "slidebarleft_x", "slidebarleft_y", "slidebarright_x",
    #                    "slidebarright_y"]])

    # verify_info = data.loc[0, ["first_x", "first_y", "second_x", "second_y", "scenario", "terminal"]]
    verify_info = data.loc[0, ["correct_x", "correct_y", "slidebarleft_x", "slidebarleft_y", "slidebarright_x",
    ...
    #                "slidebarright_x": 565, "slidebarright_y": 493.5, "scenario": 1, "terminal": 0}
    ...
    if verify_info["scenario"] == 0:
        ...
        JEDIP2 = "../Model/2018034281552_bio_reconstruct1stage2xgpc_addselinmbot_pageaddmotion_addhbc_addcrd.sav"
