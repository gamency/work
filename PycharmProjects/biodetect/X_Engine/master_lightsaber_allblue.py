...
def main():
    ...
    data = pd.read_csv("/Users/kite/Desktop/Mobile_verify/Data/trainData/PC/FirstBig/simple_bot42.csv")
    # data = pd.DataFrame()
    ...
    if verify_info["scenario"] == 0:
        ...
        # JEDI = JEDI2
        JEDIP2 = "../Model/201802061300_bio_reconstruct2fea44stage2rfpc_fixpara_17.sav"
