...
def main():
    ...
    verify_info = {"correct_x": 595, "correct_y": 302.5, "slidebarleft_x": 529, "slidebarleft_y": 457.5,
                   "lidebarright_x": 565, "slidebarright_y": 493.5, "scenario": 0, "terminal": 0}

    JEDIP1 = "../Model/201801231553_bio_reconstructstage1xgpc.sav"
    JEDI1 = pickle.load(open(JEDIP1, 'rb'))

    JEDIP2 = "../Model/201801231915_bio_reconstruct1stage2xgpc.sav"
    JEDI2 = pickle.load(open(JEDIP2, 'rb'))
