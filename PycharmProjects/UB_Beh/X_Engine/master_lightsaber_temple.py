...
def colon_soldier(base_location):
    ...
    b, be, sbe, colon_name = light_tracker(verify_inf['terminal'])
    # print()
    ...
    colon_military.to_csv("../Data_Table/ubd_behavior_ios_human_acconly.csv", index=None)
...
def main():
    ...
    # base_dir = "/Users/kite/Desktop/user_behavior_detect_preresearch/Data/trainData/Bot/H5/register_humantr"
