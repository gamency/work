...
def colon_soldier(base_location):
    ...
    colon_military.to_csv("../Data_Table/first_stage_train_version3_allblue_addsimplebot.csv", index=None)
    # colon_military.to_csv("../Data_Table/second_stage_train_version3_44fea_addsimplebot.csv", index=None)
