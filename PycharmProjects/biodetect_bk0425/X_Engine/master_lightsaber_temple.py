...
def colon_soldier(base_location):
    ...
    colon_military.to_csv("../Data_Table/second_stage_train_version3_44fea_addsimplebot_addselniumbot_pageaddmotion_bot.csv", index=None)
